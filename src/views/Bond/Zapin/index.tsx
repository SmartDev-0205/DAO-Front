...
import { busd as busdToken, bnb as bnbToken } from "../../../helpers/tokens";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    let defaultToken = tokens.find(token => token.name === busdToken.name);

    if (bond.name === wbnb.name) {
        defaultToken = tokens.find(token => token.name === bnbToken.name);
    }
    ...
    return (
        <Modal id="hades" open={open} onClose={handleClose} hideBackdrop>
            <Paper className="nmeta-card nmeta-popover zapin-poper">
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} NMETA`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} NMETA`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 NMETA</p>
                            </div>
                        </div>
                    </div>
