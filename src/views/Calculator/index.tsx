...
function Calculator() {
    ...
    const [nusdAmount, setNusdAmount] = useState(trimmedNusdBalance);
    ...
    const calcInitialInvestment = () => {
        const nusd = Number(nusdAmount) || 0;
        const price = parseFloat(priceAtPurchase) || 0;
        const amount = nusd * price;
    ...
    }, [days, rewardYield, futureMarketPrice, nusdAmount]);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-apy">
                                            <p className="calculator-card-metrics-title">NMETA Price</p>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-index">
                                            <p className="calculator-card-metrics-title">Your NUSD Balance</p>
                                            <p className="calculator-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedNusdBalance} NUSD</>}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="calculator-card-area">
                            <div>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">NUSD Amount</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    ...
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setNusdAmount(trimmedNusdBalance)} className="stake-card-action-input-btn">
                                                                <p>Max</p>
                                                            </div>
                                                        </InputAdornment>
                                                    }
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">NMETA price at purchase ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">Future NMETA market price ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <div className="calculator-user-data">
                                    ...
                                    <div className="data-row">
                                        <p className="data-row-name">NMETA rewards estimation</p>
                                        <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} NMETA</>}</p>
                                    </div>
                                    <div className="data-row">
