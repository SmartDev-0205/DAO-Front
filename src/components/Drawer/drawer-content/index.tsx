...
import NowDaoIcon from "../../../assets/icons/nowdao-nav-header.png";
    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://nowdao.money" target="_blank">
                    <img alt="" src={NowDaoIcon} style={{ maxWidth: 96 }} />
                </Link>
            ...
            <div className="dapp-menu-doc-link">
                <Link href="https://snapshot.org/#/nowdao.eth/" target="_blank">
                    <div className="dapp-menu-item">
                        <img alt="" src={GovernanceIcon} />
                        <p>Governance</p>
                    </div>
                </Link>
                {/* <Link href="https://nowdao.gitbook.io/nowdao/" target="_blank">
